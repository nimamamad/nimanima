...
playerLeft.src = 'fish-sweem-left.png';
...
class Enemy {
	...
	draw(){
		...
		ctx.arc(this.x, this.y, this.radius, 0, Math.PI * 2);
		ctx.fill();*/
		ctx.drawImage(enemyImage, this.frameX * this.spriteWidth, this.frameY * this.spriteHeight, this.spriteWidth, this.spriteHeight, this.x - 80, this.y - 100, this.spriteWidth / 3, this.spriteWidth / 3)
	}
	update(){
